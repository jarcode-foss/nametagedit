...
public class NametagChangeEvent extends Event implements Cancellable {
    ...
    /**
     * Returns the prefix that is going to be set if this
    ...
    /**
     * Returns the suffix that is going to be set if this
     * event is not cancelled
     *
    ...
    /**
     * Returns the type of nametag change the player will
     * undergo if this event is not cancelled
     * </br></br>
     * NametagChangeType.HARD - The current prefix and suffix
     * is completely overwritten by the new ones.
     * </br></br>
     * NametagChangeType.SOFT - The current prefix and suffix
     * is set only if the new prefix/suffix is not null/empty.
     * Null and empty prefixes and suffixes will not be set.
     *
     ...
     * </br></br>
     *
     * NametagChangeReason.SET_PREFIX - The prefix was
     * set with the /ne command
     * </br></br>
     *
     * NametagChangeReason.SET_SUFFIX - The suffix was
     * set with the /ne command
     * </br></br>
     *
     * NametagChangeReason.GROUP_NODE - The group node
     * was set from logging in or resetting the nametag
     * back to the default.
     * </br></br>
     *
     * NametagChangeReason.CUSTOM - The nametag is being
     * set from outside of NametagEdit.
     *
     ...
     *
     * @param cancelled the boolean to set as the
     *                  cancelled state.
     */
    ...
    /**
     * Represents the reason or cause for the change of a
     * player's nametag.
     */
